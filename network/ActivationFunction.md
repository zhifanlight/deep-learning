...
- 单调连续，将输出映射在 (0, 1) 区间，输出值可作为概率，可用于输出层
...
- 解决了 sigmoid 函数不能输出负数的问题

- 导数比 sigmoid 大，收敛速度比 sigmoid 快
...
- 函数定义与 Leaky ReLU相同，但是将 \\(\alpha\\) 也作为待学习的参数
...
- 由于导数为 sigmoid 函数，处处小于 1，无法避免梯度消失问题
